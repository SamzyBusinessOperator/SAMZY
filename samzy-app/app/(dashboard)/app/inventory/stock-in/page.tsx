...
export default async function StockInPage({
  ...
  async function addStock(formData: FormData) {
    ...
    if (!productId) {
      redirect(
        `/app/inventory/stock-in?error=${encodeURIComponent(
    ...
    if (
      ...
      redirect(
        `/app/inventory/stock-in?product=${encodeURIComponent(
          productId,
    ...
    /*
     * Confirm the product belongs to the
    ...
    /*
     * IMPORTANT:
     * We do NOT update products.current_stock here.
     *
     * This insert triggers apply_inventory_movement()
     * in PostgreSQL, which:
     *
     * 1. locks the product row
     * 2. reads current stock
     * 3. calculates the new stock
     * 4. records before_stock / after_stock
     * 5. updates products.current_stock
     */
    ...
    redirect(
      "/app/inventory?success=stock-in",
    );
  }
        ...
        <div className="mt-5 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-[#667085]">
              Receive inventory and add stock to
              an existing product.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <section className="rounded-2xl border border-[#eaecf0] bg-white p-6 shadow-sm">
          <div>
            ...
            <p className="mt-1 text-sm text-[#667085]">
              Select the product receiving stock.
            </p>
          </div>
          ...
          {selectedProduct ? (
            <div className="mt-6 grid gap-4 sm:grid-cols-3">
              ...
              <InfoCard
                ...
                value={`${formatQuantity(
                  Number(
                    selectedProduct.reserved_stock,
                  ),
                )} ${selectedProduct.unit}`}
              />
        ...
        <section className="rounded-2xl border border-[#eaecf0] bg-white p-6 shadow-sm">
          <div>
            ...
            <p className="mt-1 text-sm text-[#667085]">
              Add context so this stock movement
          ...
          <div className="mt-6 grid gap-5">
            <label>
              ...
              <input
                name="reason"
                type="text"
                placeholder="Example: Initial inventory"
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-emerald-700">
                SAMZY will record this transaction
                in inventory history and automatically
