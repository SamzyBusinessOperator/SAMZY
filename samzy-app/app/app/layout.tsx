    ...
    <div className="min-h-screen bg-[#f8f9fb] text-[#101828]">
      ...
      <div className="lg:pl-60">
        <header className="sticky top-0 z-20 flex h-20 items-center justify-between border-b border-[#eaecf0] bg-white/90 px-6 backdrop-blur-xl lg:px-10">
          <div>
            <p className="text-sm text-[#667085]">Workspace</p>
            <p className="font-semibold">{organizationName}</p>
          </div>

          <div className="flex items-center gap-3">
            <button className="hidden h-10 min-w-64 rounded-xl border border-[#d0d5dd] bg-white px-4 text-left text-sm text-[#98a2b3] md:block">
              Search anything...
            </button>
