...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompts: Record<string, string> = {
      inventory: `Analyze this delivery note and extract ALL products listed. IMPORTANT: Use the EXACT category name as written in the document column - do not change, guess or reclassify. Copy it exactly as printed.
